				...
				<div class="container-content container">
					<div class="row" style="width: 100%; padding-left: 100px; padding-right: 100px;">
						<div class="card text-white" style="background-color: #24262D; width: 100%;">
							<div class="card-body">
								<div class="row">
									<h5 class="card-title mb-3 col-11">Adicionar Funcionarios</h5>
								</div>
								<div style="margin-top: 50px;">
									<form action"employee" method="post">
										  <div class="row">
										  	<div class="col">
										  		<input type="text" class="form-control col" required id="name" name="name" placeholder="Insira o nome">
										  	</div>
										  	<div class="col">
										    	<input type="text" class="form-control col" required id="cpf" name="cpf" placeholder="Insira o cpf">
										   	</div>
										  </div>
										  ...
										  <div class="row mt-4">
											...
											<div class="col-4">
												<input type="email" class="form-control col"required id="email" name="email" placeholder="Insira o email">
											</div>
											<div class="col-4">
